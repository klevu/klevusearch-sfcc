...
const Logger = LogUtils.getLogger('klevuMasterProductsPriceDeltaExport');
...
function write(lines) {
    if (!empty(lines) && lines.length) {
        productUtils.writeMasterData(lines, refinementAttrArray, isFullExport, executePriceExportInFullExport);
    }
}
